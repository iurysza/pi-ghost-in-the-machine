...
- Polls never overlap. Each one sends `{"method":"pane.layout","params":{}}`, parses `result.layout.area.x`, and waits for the response before scheduling the next request.
